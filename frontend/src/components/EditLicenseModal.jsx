...
export const EditLicenseModal = ({ open, onOpenChange, onSubmit, license }) => {
  ...
  useEffect(() => {
    if (license) {
      setFormData({
        nombre_licencia: license.nombre_licencia || "",
        codigo_licencia: license.codigo_licencia || "",
        estado: license.estado || "Disponible",
        usuario_final: license.usuario_final || "",
        area_usuario: license.area_usuario || "",
        vigencia: license.vigencia || "",
      });
    }
  }, [license]);
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit(license.id, dataToSubmit);
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Modifique los datos de la licencia</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input
                data-testid="edit-license-name-input"
                id="nombre_licencia"
            ...
            <div className="grid gap-2">
              ...
              <Input
                data-testid="edit-license-code-input"
                id="codigo_licencia"
            ...
            <div className="grid gap-2">
              ...
              >
                <SelectTrigger data-testid="edit-license-status-select">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            {(formData.estado === "Instalada" || formData.estado === "Reasignada") && (
              <>
                <div className="grid gap-2">
                  ...
                  <Input
                    data-testid="edit-license-user-input"
                    id="usuario_final"
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    data-testid="edit-license-area-input"
                    id="area_usuario"
            ...
            <div className="grid gap-2">
              ...
              <Input
                data-testid="edit-license-expiry-input"
                id="vigencia"
          ...
          <DialogFooter>
            ...
            <Button
              data-testid="submit-edit-license-btn"
              type="submit"
